...
@Composable
fun ProfCitizenship(viewModel: OquvchilarViewModel = hiltViewModel()) {
    val scrollState = rememberScrollState()
    val genderChartData by viewModel.citGenderChartData.collectAsState()
    val ageChartData by viewModel.citAgeChartData.collectAsState()
    val livePlaceChartData by viewModel.citLivePlaceChartData.collectAsState()
    val courseChartData by viewModel.citCourseChartData.collectAsState()

    LaunchedEffect(Unit) { viewModel.fetchCitizenship() }
