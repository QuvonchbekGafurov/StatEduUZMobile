...
@Composable
fun ProfAgeScreen(viewModel: OquvchilarViewModel = hiltViewModel()) {
    val scrollState = rememberScrollState()
    val genderChartData by viewModel.ageGenderChartData.collectAsState()
    val livePlaceChartData by viewModel.ageLivePlaceChartData.collectAsState()

    LaunchedEffect(Unit) { viewModel.fetchAges() }
