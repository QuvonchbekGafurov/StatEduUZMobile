...
@Composable
fun ProfEduFormScreen(viewModel: OquvchilarViewModel = hiltViewModel()) {
    val scrollState = rememberScrollState()
    val genderChartData by viewModel.eduFormGenderChartData.collectAsState()
    val ageChartData by viewModel.eduFormAgeChartData.collectAsState()
    val livePlaceChartData by viewModel.eduFormLivePlaceChartData.collectAsState()
    val ptChartData by viewModel.eduFormPTChartData.collectAsState()
    val courseChartData by viewModel.eduFormCourseChartData.collectAsState()
    val citizenshipChartData by viewModel.eduFormCitizenshipChartData.collectAsState()

    LaunchedEffect(Unit) { viewModel.fetchEducationForms() }
