...
@Composable
fun ProfCourse(viewModel: OquvchilarViewModel = hiltViewModel()) {
    val scrollState = rememberScrollState()
    val genderChartData by viewModel.courseGenderChartData.collectAsState()
    val ageChartData by viewModel.courseAgeChartData.collectAsState()
    val livePlaceChartData by viewModel.courseLivePlaceChartData.collectAsState()
